...
\textsc{Teaching Repository:} & \url{https://github.com/computoCienciasUniandes/}\\ 
...
\section{Brief Bio}
\color{black}
Computational astrophysicist with 15 years experience doing research. 
Passionate about helping others to develop their computational
skills. 8 years experience teaching from undergraduate to postgraduate
level.  
...
\begin{itemize}
\item Refereed journal articles:  37 articles (10.1 normalized count) since first paper in 2007. 
\item Google Scholar statistics. Total Number of Citations: 1309. H-index: 17.
\item SAO/NASA Astrophysics Data System statistics. Total Number of
  Citations: 962. H-index: 15. 
\end{itemize}
