...
\begin{itemize}
\item Refereed journal articles:  30 published + 3 submitted (since
  first paper in 2007).
\item Google Scholar statistics. Total Number of Citations: 953. H-index: 16.
\item SAO/NASA Astrophysics Data System statistics. Total Number of
  Citations: 751. H-index: 14. 
\end{itemize}
...
\item[30] {\it Unbiased clustering estimates with the DESI fibre
...
\item[29] {\it We are not the 99 percent: quantifying
  asphericity in the distribution of Local Group satellites}, {\bf
    J. E. Forero-Romero}, V. Arias,  MNRAS, 478, 5533, 2018.
...
Guiderdoni B.,  MNRAS, Vol. 379, Issue 4, pp. 1507-1518, (2007). $[c_{10}=10]$
\end{enumerate}
