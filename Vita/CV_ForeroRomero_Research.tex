...
\begin{itemize}
\item Refereed journal articles:  26 published + 2 submitted (since
  first paper in 2007).
\item Google Scholar statistics. Total Number of Citations: 669. H-index: 13.
\item SAO/NASA Astrophysics Data System statistics. Total Number of Citations: 583. H-index: 13.
\end{itemize}
\subsection{Refereed Publications}
\begin{enumerate}

\subsubsection{2017}
\item[28]{\it Tracing the cosmic web}, N. I. Libeskind, R. van de Weygaert, M. Cautun, B. Falck, E.
...
R. S. Stoica, Th. Sousbie, G. Yepes, MNRAS submitted.  

\item[27]{\it Modelling the gas kinematics of an atypical Lyman alpha
