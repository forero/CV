...
\item [-] 2016: {\bf The Language that Cosmology
  ...
  cosmologies (traditional, contemporary, physical, metaphysical). % una palabra en varios idiomas (o cada palabra en un idioma) + una imagen + un texto corto en ingles (algo de corte filosofico)? Palabra en idioma + imagen + texto corto en el idioma correspondiente. (Muisca, Espanol, Ingles, Frances, Aleman, Hebreo, Japones, Coreano, Chino, Hindi, Finlandes, Portugues, Etiopia, Arabe, Levant, Dakota, Kubeo, Italiano, Ruso(cosmismo!), Islandes, Griego). Como una variantologia. Traduccion completa (en hoja aparte) ingles/espanol/frances/aleman.
